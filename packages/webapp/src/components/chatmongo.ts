...
export const defaultOptions: ChatComponentOptions = {
  ...
  promptSuggestions: [
    'Quel sont les différentes activités de Top Chrono?',
    'Quel sont les livraisons disponible au sien de Top Chrono?',
    'Qui sont les membres officiels de L equipe technique de Tech Chrono ?',
  ],
  messages: [],
  strings: {
    promptSuggestionsTitle: 'Posez une question ou essayez un exemple',
    citationsTitle: 'Citations :',
    followUpQuestionsTitle: 'Questions de suivi :',
    chatInputPlaceholder: 'Posez-moi une question...',
    chatInputButtonLabel: 'Envoyer la question',
    assistant: 'Assistant de support',
    user: 'Vous',
    errorMessage: 'Nous rencontrons actuellement un problème.',
...
export class ChatComponentMongo extends LitElement {
  ...
  static override styles = css`
    :host {
      /* Base properties */
      --primary: var(--azc-primary, #0078d4);
